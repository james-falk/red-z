 ...
 * 
 * SECURITY:
 * - Client-side validation with Zod (enforced server-side too)
 * - Password policy: >=10 chars, letter + number
 * - Normalizes email before submit
 * - Generic success message (non-enumerating)
 * - No indication if email already exists
...
export default function SignUpPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        // SECURITY: Always show success regardless of whether account existed
        setSuccess(true);
      } else {
        // Server error (rate limit, validation, etc.)
